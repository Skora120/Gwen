 ...
 -->
      ...
      <li class="nav-item">
        <a class="nav-link" href="charts.html">
          ...
          <span>Przedmiot 1</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="charts.html">
          <i class="fas fa-fw fa-graduation-cap"></i>
          <span>Przedmiot 2</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="charts.html">
          <i class="fas fa-fw fa-graduation-cap"></i>
          <span>Przedmiot 3</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="charts.html">
          <i class="fas fa-fw fa-graduation-cap"></i>
          <span>Przedmiot 4</span></a>
      </li>
...
<!--       <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="charts.html">
          ...
          <span>Zadanie 1</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="charts.html">
          <i class="fas fa-fw fa-meteor"></i>
          <span>Zadanie 2</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="charts.html">
          <i class="fas fa-fw fa-meteor"></i>
          <span>Zadanie 3</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="charts.html">
          <i class="fas fa-fw fa-meteor"></i>
          <span>Zadanie 4</span></a>
      </li>
...
<!--                 <div class="card-header py-3">
  ...
  <script type="text/javascript">
    ...
    $("div#dropzone").dropzone({ url: "/file/post", autoProcessQueue: false, uploadMultiple: true });
